...
public class Arcs extends Canvas
{
	...
	public void paint( Graphics window )
	{
      ...
      createArc(window, Color.YELLOW, 350, 250, 60, 60, 0, 135);
	}
   
   public void createArc( Graphics window, Color color, int x, int y, int width, int height, int startAngle, int arcAngle )
   {
